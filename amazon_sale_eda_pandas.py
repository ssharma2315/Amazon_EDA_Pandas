...
# Calculating the total revenue that can potentially be recovered
# This represents the value of high-priority at-risk orders
Recoverable_revenue = priority_risk_df["Amount"].sum()


# Calculating what percentage of total at-risk revenue is recoverable
# Helps quantify the impact of focusing on priority orders
round(
    (priority_risk_df["Amount"].sum() / At_risk_df1["Amount"].sum()),
    2
) * 100
